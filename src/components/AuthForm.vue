<template>
    ...
    <form class="flex flex-col mb-8 max-w-lg mx-auto mt-8" @submit.prevent="login" v-if="!loginDisabled">
        ...
        <div class="my-8">
            <custom-input type="text" v-focus v-model="loginData.username" placeholder="Username" />
            <custom-input type="password" v-model="loginData.password" placeholder="Password" />
        </div>
        <custom-button type="submit" v-if="!processingRequest"> Log in </custom-button>
    ...
    <form class="flex flex-col mb-8 max-w-lg mx-auto mt-8" @submit.prevent="register" v-if="!registerDisabled">
        ...
        <div class="my-8">
            <custom-input type="text" v-focus v-model="registerData.username" placeholder="Username" />
            <custom-input type="password" v-model="registerData.password" placeholder="Password" />
            <custom-input type="password" v-model="registerData.repeat_password" placeholder="Repeat password" />
        </div>
        <custom-button type="submit" v-if="!processingRequest"> Sign up </custom-button>
        <custom-button v-else disabled><custom-spinner class="w-5 h-5"/></custom-button>
    </form>  
</template>
