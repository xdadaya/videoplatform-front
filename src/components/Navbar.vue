...
<template>
    <my-dialog v-model:isVisible="dialogVisible">
    ...
    <nav class="bg-white dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2">
                <my-button @click="showDialog" v-if="!isAuth"> Authorize &#8658; </my-button>
                <my-button @click="() => isAuth=false" v-else> Log out &#8656; </my-button>
            ...
            <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" :class="{'hidden': hidden}" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <my-link @click="$router.push(indexUrl)" :isSelected="currentUrl === indexUrl"> Home </my-link>
                    </li>
                    <li>
                        <my-link @click="$router.push(aboutUrl)" :isSelected="currentUrl === aboutUrl"> About </my-link>
                    </li>
                    <li>
                        <my-link @click="$router.push(servicesUrl)" :isSelected="currentUrl === servicesUrl"> Services </my-link>
                    </li>
                    <li>
                        <my-link @click="$router.push(contactsUrl)" :isSelected="currentUrl === contactsUrl"> Contact </my-link>
                    </li>
                </ul>
            </div>
        </div>
